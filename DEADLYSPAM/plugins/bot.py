...
DEAD_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/226a73b069a28a0183ed3.mp4"
  

DEADLY = "✯ 『⛦⃕͜🔥『𝐒𝐀𝐍𝐊𝐈』亗 𝐒𝐏𝐀𝐌<𝟐⛦⃕͜🔥 ✯\n\n"
DEADLY += f"═══════════════════\n"  
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await BOT0.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("Channel", "https://t.me/Esport_Bots"),
        Button.url("Sankii Group", "https://t.me/Its_Sanki")
        ],
        [
        Button.url("Repo", "https://t.me/Himu_Xd")
        ]
        ]
        )
...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        ...
        await event.edit(f"🎉 Ping @Its_Sanki  !\n\n♡︎ `{ms}` 𝗺𝘀 ♡︎")
